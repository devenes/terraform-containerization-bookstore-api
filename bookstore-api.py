...
app.config['MYSQL_DATABASE_USER'] = 'devenes'
...
# Write a function named `home` which returns 'Welcome to the Enes's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Enes's Bookstore API Service"
